...
const endowmentClaim: Claim = {
  ...
  evidenceLinks: [
    {
      ...
      role: "supports",
      note: "USGS reserve figures are the primary basis for this claim.",
    },
  ],
  entityIds: ["ENT-DRC", "ENT-COBALT"],
  confidence: "high",
  ...
  whatThisDoesNotProve: [
    ...
    "It does not imply that EEO has independently verified DRC government reserve estimates.",
    "Reserve concentration in one jurisdiction does not determine global supply security.",
  ],
  whatWouldReviseThisClaim: [
