...
const endowmentClaim: Claim = {
  id: "CLAIM-DRC-CO-002",
  recordMode: "synthetic",
  title: "USGS estimates DRC held about 55% of global cobalt reserves",
  plainLanguageClaim:
  ...
  evidenceLinks: [
    {
      ...
      role: "supports",
      note: "The 2026 USGS cobalt reserve table and official country summary are the basis for the bounded 55% estimate.",
    },
  ],
  entityIds: ["ENT-DRC", "ENT-COBALT"],
  confidence: "high",
  ...
  rightOfReplyStatus: "not_required",
  whatThisDoesNotProve: [
    "It does not imply that EEO independently measured or verified the reserve estimate.",
    "It does not establish mine-level recoverability at any given price, technology, or classification threshold.",
    "It does not establish ownership, entitlement, sovereignty, or allocation rights over cobalt reserves.",
    "It does not describe extraction rates or social and ecological conditions at specific sites.",
    "Reserve concentration does not by itself demonstrate physical chain of custody, supply security, public benefit, or stewardship quality.",
  ],
  whatWouldReviseThisClaim: [
    "Updated USGS or equivalent authoritative reserve estimates.",
    "A material change in reserve definitions, methods, classifications, or the global denominator.",
    "New geological surveys or discoveries materially changing known reserve volumes or relative concentration.",
  ],
