// Archived one-file handoff. Canonical implementation: ../components/EarthEndowmentObservatoryOneFileApp.tsx
        ...
        <div className="relative grid gap-8 p-8 md:grid-cols-[1.2fr_0.8fr] md:p-12 lg:p-16">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <button onClick={() => setActive("dossier")} className="rounded-full bg-[#C9A24D] px-5 py-3 text-sm font-semibold text-stone-950 shadow-sm hover:brightness-105">
                Open evidence dossier
              </button>
              <button onClick={() => setActive("ledger")} className="rounded-full border border-white/25 px-5 py-3 text-sm font-semibold text-white hover:bg-white/10">
                Inspect evidence ledger
              </button>
              <button onClick={() => setActive("workspace")} className="rounded-full border border-white/25 px-5 py-3 text-sm font-semibold text-white hover:bg-white/10">
      ...
      <div className="grid gap-6 lg:grid-cols-[0.85fr_1.15fr]">
        <Card className="p-6">
          ...
          <div className="mt-5 space-y-4">
            <input placeholder="Name or institution" className="w-full rounded-2xl border border-stone-300 bg-white px-4 py-3 text-sm outline-none focus:border-stone-900" />
            <input placeholder="Contact email" className="w-full rounded-2xl border border-stone-300 bg-white px-4 py-3 text-sm outline-none focus:border-stone-900" />
            <select className="w-full rounded-2xl border border-stone-300 bg-white px-4 py-3 text-sm outline-none focus:border-stone-900">
            ...
            <textarea placeholder="Describe the issue, claim ID, source, or safety concern..." rows={6} className="w-full rounded-2xl border border-stone-300 bg-white px-4 py-3 text-sm outline-none focus:border-stone-900" />
