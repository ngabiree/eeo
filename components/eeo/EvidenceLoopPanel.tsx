  ...
  return (
    ...
    >
      <h2 id="evidence-loop-heading" className="text-lg font-semibold text-[color:var(--eeo-ink)]">
        Governed publication chain (reference)
      </h2>
      <p className="mt-2 text-sm leading-relaxed text-[color:var(--eeo-muted)]">
        Synthetic sample data only; no live evidence vault, durable audit log, or production release signing.
      </p>
      ...
      <p className="mt-4 text-xs leading-relaxed text-[color:var(--eeo-muted)]">
        For the public methods, limits, and disclosure posture, use the Methods and Safeguards pages.
      </p>
    </section>
  );
}
