...
const footerColumns = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Evidence Dossier", href: "/corridors/copper-cobalt/dossier" },
  ...
  },
  {
    title: "Corridor",
    links: [
      { label: "Copper-Cobalt Corridor", href: "/corridors/copper-cobalt" },
      { label: "Governance Profile", href: "/corridors/copper-cobalt/governance" },
      { label: "Value Chain", href: "/corridors/copper-cobalt/value-chain" },
      { label: "Labor, Ecology & Revenue", href: "/corridors/copper-cobalt/labor-ecology-revenue" },
    ],
  },
  {
